...
async function buildBookmarklet() {
  ...
  try {
    ...
    console.log(
      `✓ Minified: ${minifiedCode.length} bytes (${Math.round(
        (minifiedCode.length / combined.length) * 100
      )}% of original)\n`
    );
    ...
    // Escape bookmarklet code for safe injection into JavaScript string literal (double quotes)
